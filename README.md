...
ม็อดนี้เพิ่มการรองรับภาษาไทยแบบเต็มรูปแบบสำหรับ **Astral Party** บน Steam (เวอร์ชั่น INT) โดยแก้ไข 3 จุดหลัก:

- Unity DynamicFont ไม่รองรับ GPOS สำหรับภาษาไทย → ใช้ font ที่ bake ตำแหน่งวรรณยุกต์เอง
- วรรณยุกต์ (่ ้ ๊ ๋) ทับสระบน (ี ื) → ยกวรรณยุกต์ขึ้น 277 units
- การค้นหาคำแปลทำให้ UI กระตุก → ใช้ cache แบบ pre-parsed ใน DLL
